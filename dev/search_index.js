...
{
    "location": "variables/#JuMPArrays-1",
    "page": "Variables",
    "title": "JuMPArrays",
    "category": "section",
...
{
    "location": "variables/#Dictionaries-1",
    "page": "Variables",
    "title": "Dictionaries",
    "category": "section",
...
{
    "location": "variables/#Forcing-the-container-type-1",
    "page": "Variables",
...
{
    "location": "constraints/#JuMP.result_dual",
    "page": "Constraints",
    "title": "JuMP.result_dual",
    "category": "function",
    "text": "result_dual(cr::ConstraintRef)\n\nGet the dual value of this constraint in the result returned by a solver. Use has_result_dual to check if a result exists before asking for values. See also shadow_price.\n\n\n\n\n\n"
},

{
    ...
    "category": "function",
    "text": "shadow_price(constraint::ConstraintRef)\n\nThe change in the objective from an infinitesimal relaxation of the constraint. This value is computed from result_dual and can be queried only when has_result_dual is true and the objective sense is MinSense or MaxSense (not FeasibilitySense). For linear constraints, the shadow prices differ at most in sign from the result_dual value depending on the objective sense.\n\nNotes\n\nThe function simply translates signs from result_dual and does not validate the conditions needed to guarantee the sensitivity interpretation of the shadow price. The caller is responsible, e.g., for checking whether the solver converged to an optimal primal-dual pair or a proof of infeasibility.\nThe computation is based on the current objective sense of the model. If this has changed since the last solve, the results will be incorrect.\nRelaxation of equality constraints (and hence the shadow price) is defined based on which sense of the equality constraint is active.\n\n\n\n\n\n"
},

{
    "location": "constraints/#Duals-1",
    "page": "Constraints",
    "title": "Duals",
    "category": "section",
    "text": "JuMP.result_dual\nJuMP.shadow_price"
},
...
{
    "location": "containers/#Containers-in-macro-1",
    "page": "Containers",

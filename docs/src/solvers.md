...
The file formats are defined [within MathOptInterface in the FileFormats enumeration](https://jump.dev/MathOptInterface.jl/latest/apireference/index.html#MathOptInterface.FileFormats.FileFormat).

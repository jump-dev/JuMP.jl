...
#   `MOI.LazyConstraint` and `MOI.UserCut`
# * Provide heuristic solutions to the solver via `MOI.HeuristicSolution` to
#   speed up the search for integer-feasible points

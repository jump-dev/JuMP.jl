...
# Maximum production capacity in (month, factory):
...
# Minimum production capacity in (month, factory):
...
# Variable cost of production in (month, factory):
...
# Fixed cost of production in (month, factory):

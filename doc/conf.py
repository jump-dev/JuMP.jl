...
project = u'JuMP -- Julia for Mathematical Optimization'
...
latex_documents = [
  ('index', 'JuMP.jl.tex', u'JuMP.jl Documentation',
   AUTHORS, 'manual'),
]
...
man_pages = [
    ('jump', 'JuMP', u'JuMP.jl Documentation',
     [AUTHORS], 1)
]
...
texinfo_documents = [
  ('jump', 'JuMP', u'JuMP.jl Documentation',
   AUTHORS, 'JuMP', 'JUMP - Julia for Mathematical Programming.',
   'Miscellaneous'),
]

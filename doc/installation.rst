...
Requires a license. Supports SOCP and "SOS" constraints. The interface is experimental and has not been widely tested, but it does pass all JuMP and MathProgBase tests. Callbacks are not yet supported.
